...
public class MainActivity extends Activity {
	...
	public void onClickImageView1(View view) {
		...
		// Animation...
		TranslateAnimation animation = new TranslateAnimation(0, m, 0, n);//从0原位，左右移动m，上下移动n
		...
		if (i == 1) {
			...
			Toast.makeText(this, "我这里有1张招财进宝符，保佑你好财运", Toast.LENGTH_LONG).show();
	...
	public void onClickImageView2(View view) {
		...
		if (j <= 2) {
			...
			Toast.makeText(this, "我还进不去小屋!", Toast.LENGTH_LONG).show();
		}
	}
